...
static bmp_err_t read_chip_id (void)
{
	...
	HAL_I2C_Mem_Read(&hi2c3, BMP_READ_ADDR, BMP_CHIP_ID_REG, 1, &out_buff, 1, BMP_I2C_TIMEOUT);
...
static void set_oss (oss_t * oss, oss_ratio_t ratio)
{
	...
	HAL_I2C_Mem_Write( &hi2c3, BMP_WRITE_ADDR, BMP_CTRL_REG, 1, in_buff, 2, BMP_I2C_TIMEOUT );
}
...
static bmp_err_t read_calib_data (short * calib_data)
{
	...
	HAL_I2C_Mem_Read(&hi2c3, BMP_READ_ADDR, BMP_CALIB_ADDR, 1, out_buff, BMP_CALIB_DATA_SIZE, BMP_I2C_TIMEOUT);
...
int32_t get_ut (void)
{
	...
	HAL_I2C_Mem_Write( &hi2c3, BMP_WRITE_ADDR, BMP_CTRL_REG, 1, out_buff, 1, BMP_I2C_TIMEOUT );
	HAL_Delay (BMP_TEMP_CONV_TIME);
	HAL_I2C_Mem_Read ( &hi2c3, BMP_READ_ADDR, BMP_DATA_MSB_ADDR, 1, out_buff, 2, BMP_I2C_TIMEOUT );
...
int32_t get_up (oss_t oss)
{
	...
	HAL_I2C_Mem_Read(&hi2c3, BMP_READ_ADDR, BMP_DATA_MSB_ADDR, 1, out_buff, 3, BMP_I2C_TIMEOUT);
